...
import { apiPostVerifyOtpLogin} from '@/api/auth/postVerifyOtpLogin';
...
export default function OtpScreen() {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({ title: "OTP Đăng nhập",   headerStyle: {
      backgroundColor: "#fff", 
    },});
  }, [navigation]);
  ...
  const verifyOtp = async (otpValue: string) => {
    try {
      const res = await apiPostVerifyOtpLogin(
