...
import { attendance_Check_In, attendance_Check_Out} from "../api/attendance";
...
export default function CheckInScreen() {
    ...
    const handleCheckIn = async () => {
        ...
        try {
            ...
            ToastHelper.custom({
                ...
                onHide: () => router.push("/timekeeping/Attendance-Detail"),
            });
            setCheckedInToday(true);
    ...
    const handleCheckOut = async () => {
        try {
            ...
            setTimeout(() => {
                router.replace("/timekeeping/Attendance-Detail");
            }, 2000);
        } catch (err) {
