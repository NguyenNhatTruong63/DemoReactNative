...
import { ScrollView, View, Text, TextInput, TouchableOpacity, Image, StyleSheet, ActivityIndicator, KeyboardAvoidingView, Platform, } from "react-native";
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (!dateRegex.test(joining_date)) {
        Toast.show({ type: "error", text1: "Ngày tham gia  không đúng định dạng DD/MM/YYYY" });
        return;
      }
