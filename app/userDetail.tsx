...
//   //       if (parsedUserData) {
//   //         // Nếu có dữ liệu từ props (userData), dùng luôn
//   //         setUser(parsedUserData);
//   //         setName(parsedUserData.name || "");
//   //         setBirthday(parsedUserData.birthday || "");
//   //         setJoining_date(parsedUserData.joining_date || "");
//   //         setGender(parsedUserData.gender?.toString() || "");
//   //         setEmail(parsedUserData.email || "");
//   //         setPhone(parsedUserData.phone || "");
//   //         setIdCard(parsedUserData.id_card_number || "");
//   //         setAddress(parsedUserData.address || "");
//   //         setDepartmentId(parsedUserData.department_id || 0);
//   //         setDepartmentName(parsedUserData.departments || "Không có phòng ban");
//   //         setUsername(parsedUserData.username || parsedUserData.login_name || "");
...
//   //     } catch (err) {
//   //       console.log("ERR DETAIL:", err);
//   //       Toast.show({ type: "error", text1: "Lỗi tải thông tin người dùng" });
//   //     } finally {
//   //       setLoading(false);
//   //     }
//   //   };
...
//   //       router.push({
//   //         pathname: "/(tabs)/person",
//   //         params: { userData: JSON.stringify(newUser) },
//   //       });
